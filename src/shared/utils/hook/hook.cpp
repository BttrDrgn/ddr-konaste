...
namespace utils::hook
{
	...
	void detour::create(void* place, void* target)
	{
		...
		{
			throw std::runtime_error(utils::format::va("Unable to create hook at location: %p", this->place_));
		}
	...
	bool iat(const utils::nt::library& library, const std::string& target_library, const std::string& process, void* stub)
	{
